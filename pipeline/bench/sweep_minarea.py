...
print(f"min_area at {WORK}px long edge, scale 1.0 = {segment.RADIUS_REF_AT_1400:.0f}px "
...
for stem, q, lab, mask in prepared:
    ...
    for s in SCALES:
        seg = segment.segment(
            ...
            budget=BUDGET, subject_mask=mask, min_radius_scale=s,
        )
